...
import type { CompletionRecord, BibleData, ReadingPlan } from '../types'
...
export default function ReadingReview({
  isOpen, onClose, completions, ckjv, readingPlan, onSetPlan, onClearPlan,
}: Props) {
        ...
        <div className="px-5 py-4 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              >
                <span className="text-xl font-bold text-stone-500 dark:text-[#E4DDD0]">{value}</span>

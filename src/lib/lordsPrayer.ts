  ...
  petitions: [
    {
      ...
      historicalNote:
        '耶穌教導門徒稱上帝為父，在當時既親密又顛覆。初代教會在洗禮與崇拜中常用主禱文，作為共同身份的聲音記號。',
      commonMisconception:
    ...
    },
    {
      ...
      historicalNote:
        '路德解釋：上帝的名本是聖的；我們求的是它在我們中間也被尊為聖——藉真道與聖潔生活。',
      commonMisconception:
    ...
    },
    {
      ...
      historicalNote:
        '「飲食」在傳統解釋可含一切維持生命所需；教父與改教家也提醒：我們為眾人求，不只為自己。',
      commonMisconception:
    ...
    },
    {
      ...
      praysAgainst:
        '拒絕廉價恩典（只要赦我、不必悔改），也拒絕武器化「你要饒恕」來保護加害者、壓制受害者。',
      historicalNote:
    ...
    },
    {
      ...
      historicalNote:
        '希臘文可指試探或考驗。教會歷來在此求上帝保守我們不致陷入導致滅亡的試煉處境。',
      commonMisconception:
    ...
    },
    {
      ...
      historicalNote:
        '這句頌讚在崇拜傳統中極普遍，呼應歷代志上 29 等舊約頌讚語言，幫助會眾以讚美結束祈求。',
      commonMisconception:

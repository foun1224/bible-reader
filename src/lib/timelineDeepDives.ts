...

  {
    ...
    world: {
      ...
      humanity: {
        title: '大衛家的榮耀與傷口同時展開',
        body:
          '大衛既是合神心意的人，也是犯下姦淫、謀殺並使家庭長期破裂的人。所羅門既有無比的智慧，也因政治婚姻與外邦神明使心偏離——書上說「他的心不像他父大衛的心完全歸向耶和華他的神」（王上 11:4）。兩位王的生命都呈現同一個模式：恩賜愈大，試探的規模也愈大；成就愈輝煌，驕傲的根愈深。統一王國的敘事拒絕把領袖浪漫化：聖經讓讀者看見恩膏、才幹、詩歌與智慧都不能取代悔改與敬畏。大衛的詩篇裡有「我的罪常在我面前」（詩 51:3），也正因如此，他的破碎成為最真實的信仰告白。',
      },
      environment: {
        title: '耶路撒冷成為信仰地圖的中心',
        body:
